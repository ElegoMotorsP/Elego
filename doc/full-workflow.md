...
|-------|-------|-------------|--------------|
| **Tushar** | leads@elegomotors.com | Sales / CRM | Sales, CRM |
| **Rajshri** | elegoac@gmail.com | Accounts | Accounting, Purchase, Sales (approver only) |
| **Manohar** | manohar.kalbhor@elegomotors.com | MD / Admin | All (final approver) |
| **Amit** | storeelegomotors@gmail.com | Store / Warehouse | Inventory, Purchase, Billing |
| **Prashant** | NPD@elegomotors.com | Purchase / NPD | Purchase, MRP, Inventory |
| **Pratik** | quality.elego23@gmail.com | QC + Manufacturing | Manufacturing, Quality, Inventory |
...
Pratik: Manufacture scooter
Pratik: QC Produced Material → OK
Pratik: Final QC Checks
