...
class ProductTemplate(models.Model):
    ...
    @api.model
    def _get_or_rename_bom_component(self, name, old_name=None):
        """Resolve a BOM component product by exact name, reusing an existing
        record under its old name (in-place rename) instead of creating a
        duplicate — used by the Elego 1.1/1.2 BOM rebuild so components
        renamed in the client's 2026-07 BOM spreadsheets keep their stock
        quantity, valuation and purchase history under the new name.

        Resolution order:
          1. A product already exists under `name` — reuse it (also covers a
             shared "1.1/1.2 ..." component already renamed by the other
             model's BOM pass, so it is not renamed twice).
          2. `old_name` is given and a product exists under it — rename that
             record to `name` in place.
          3. Neither exists — create a fresh product.
        """
        Product = self.env['product.template'].sudo().with_context(active_test=False)
        match = Product.search([('name', '=', name)], limit=1)
        if not match and old_name:
            match = Product.search([('name', '=', old_name)], limit=1)
            if match:
                match.write({'name': name})
        if match:
            if not match.active:
        ...
        _logger.info('Elego BOM: created component "%s"', name)
    ...
    def _ensure_elego_11_color_boms(self):
        ...
        color_components = {
            'Red': [
                ...
                ('1.1 FRONT PANEL LOGO PART SHINE BLACK', 1, None),
                ('1.1 FRONT PANEL LOGO DECORATION PART', 1, None),
                ('1.1 HEAD HOOD RED', 1, 'ELEGO 1.1 HEAD HOOD RED'),
                ('1.1 SIDE BODY PANEL LH RED', 1, 'ELEGO 1.1 SIDE BODY PANEL LH RED'),
                ('1.1 SIDE BODY PANEL RH RED', 1, 'ELEGO 1.1 SIDE BODY PANEL RH RED'),
                ('1.1/1.2 SIDE EDGE STRIP LH RED', 1, 'ELEGO 1.1 SIDE EDGE STRIP LH RED'),
                ('1.1/1.2 SIDE EDGE STRIP RH RED', 1, 'ELEGO 1.1 SIDE EDGE STRIP RH RED'),
                ('1.1/1.2 REAR CONNECTION RED', 1, 'ELEGO 1.1 REAR CONNECTION RED'),
                ('1.1 BAG HOOK', 1, 'ELEGO 1.1 BAG HOOK'),
                ('1.1 CHASSIS FENDER', 1, 'ELEGO 1.1 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.1 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.1 CONTROLLER CAP SMALL'),
                ('1.1/1.2 CONTROLLER FENDER', 1, 'ELEGO 1.1 CONTROLLER FENDER'),
                ('1.1/1.2 FOOT BOARD', 1, 'ELEGO 1.1 FOOT BOARD'),
                ('1.1/1.2 FOOT PLATE COVER', 1, 'ELEGO 1.1 FOOT PLATE COVER'),
                ('1.1/1.2 FOOTMAT', 1, 'ELEGO 1.1 FOOTMAT'),
                ('1.1 FRONT INNER FENDER', 1, 'ELEGO 1.1 FRONT INNER FENDER'),
                ('1.1 FRONT PANEL NET', 1, 'ELEGO 1.1 FRONT PANEL NET'),
                ('1.1/1.2 GRIP DISTANCE PIECE', 1, 'ELEGO 1.1 GRIP DISTANCE PIECE'),
                ('1.1 INSTRUMENT CLUSTER COVER', 1, 'ELEGO 1.1 INSTRUMENT CLUSTER COVER'),
                ('1.1/1.2 REAR FENDER', 1, 'ELEGO 1.1 REAR FENDER'),
                ('1.1/1.2 REAR INNER FENDER', 1, 'ELEGO 1.1 REAR INNER FENDER'),
                ('1.1/1.2 ROUND REFLECTOR', 2, 'ELEGO 1.1 ROUND REFLECTOR'),
                ('1.1/1.2 SEAT', 1, 'ELEGO 1.1 SEAT'),
                ('1.1/1.2 SEAT BARREL', 1, 'ELEGO 1.1 SEAT BARREL'),
                ('1.1/1.2 SEAT BARREL FRONT PANEL', 1, 'ELEGO 1.1 SEAT BARREL FRONT PANEL'),
                ('1.1/1.2 SQUARE REFLECTOR', 1, 'ELEGO 1.1 SQUARE REFLECTOR'),
                ('1.1/1.2 SWING ARM COVER LH', 1, 'ELEGO 1.1 SWING ARM COVER LH'),
                ('1.1/1.2 SWING ARM COVER RH', 1, 'ELEGO 1.1 SWING ARM COVER RH'),
                ('1.1 TOOL BOX', 1, 'ELEGO 1.1 TOOL BOX'),
                ('1.1 TOOL BOX CABINATE COVER', 1, 'ELEGO 1.1 TOOL BOX CABINATE COVER'),
                ('1.1/1.2 VIN COVER', 1, 'ELEGO 1.1 VIN COVER'),
                ('1.1/1.2 MIRROR SET', 1, 'ELEGO 1.1 MIRROR SET'),
                ('1.1/1.2 BATTERT CLAMP', 1, 'ELEGO 1.1 BATTERT CLAMP'),
                ('1.1 CHASSIS', 1, 'ELEGO 1.1 CHASSIS FRAME'),
                ('1.1/1.2 FRONT BRAKE CABLE HOLDER CLAMP', 1, 'ELEGO 1.1 FRONT BRAKE CABLE HOLDER CLAMP'),
                ('1.1 FRONT GUARD BRAKET', 1, 'ELEGO 1.1 FRONT GUARD BRAKET'),
                ('1.1/1.2 FRONT RIM', 1, 'ELEGO 1.1 FRONT RIM'),
                ('1.1 HANDAL BAR', 1, 'ELEGO 1.1 HANDAL BAR'),
                ('1.1/1.2 MIDDLE STAND', 1, 'ELEGO 1.1 MIDDLE STAND'),
                ('1.1/1.2 MIDDLE STAND RUBBER', 1, 'ELEGO 1.1 MIDDLE STAND RUBBER'),
                ('1.1/1.2 SEAT LATCH', 1, 'ELEGO 1.1 SEAT LATCH'),
                ('1.1/1.2 SEAT LATCH CABLE', 1, 'ELEGO 1.1 SEAT LATCH CABLE'),
                ('1.1/1.2 SIDE STAND', 1, 'ELEGO 1.1 SIDE STAND'),
                ('1.1/1.2 SWING ARM', 1, 'ELEGO 1.1 SWING ARM'),
                ('1.1/1.2 BRAKE LEVER WITH SENSOR', 1, 'ELEGO 1.1 BRAKE LEVER WITH SENSOR'),
                ('1.1/1.2 FRONT DISC BRAKE PUMP', 1, 'ELEGO 1.1 FRONT DISC BRAKE PUMP'),
                ...
                ('1.1/1.2 NUMBER PLATE', 1, 'ELEGO 1.1 NUMBER PLATE'),
                ('1.1/1.2 REAR BRAKE CABLE', 1, 'ELEGO 1.1 REAR BRAKE CABLE'),
                ('1.1/1.2 REAR BRAKE DRUM PLATE', 1, 'ELEGO 1.1 REAR BRAKE DRUM PLATE'),
                ('1.1/1.2 SIDE GUARD BAR LH', 1, 'ELEGO 1.1 SIDE GUARD BAR LH'),
                ('1.1/1.2 SIDE GUARD BAR RH', 1, 'ELEGO 1.1 SIDE GUARD BAR RH'),
                ('1.1/1.2 ANTI THEFT KIT', 1, 'ELEGO 1.1 ANTI THEFT KIT'),
                ('1.1/1.2 BATTERY CONNECTION BIG WIRE', 1, 'ELEGO 1.1 BATTERY CONNECTION BIG WIRE'),
                ('1.1/1.2 BATTERY CONNECTION SMALL WIRE', 4, 'ELEGO 1.1 BATTERY CONNECTION SMALL WIRE'),
                ('1.1/1.2 CONTROLLER 60/72', 1, None),
                ('1.1/1.2 DC CONVERTER', 1, 'ELEGO 1.1 DC CONVERTER'),
                ('1.1 DISPLY METER', 1, 'ELEGO 1.1 DISPLY METER'),
                ...
                ('1.1 MAIN WIRE HARNESS', 1, 'ELEGO 1.1 MAIN WIRE HARNESS'),
                ('1.1/1.2 MCB', 1, 'ELEGO 1.1 MCB'),
                ('1.1/1.2 MOTOR', 1, 'ELEGO 1.1 MOTOR'),
                ('1.1/1.2 NUMBER PLATE LIGHT', 1, 'ELEGO 1.1 NUMBER PLATE LIGHT'),
                ('1.1/1.2 TAIL LIGHT ASSY', 1, 'ELEGO 1.1 TAIL LIGHT ASSY'),
                ('1.1/1.2 THROTTLE + GRIP', 1, 'ELEGO 1.1 THROTTLE + GRIP'),
                ('1.1/1.2 UPPER DIPPER SWITCH', 1, 'ELEGO 1.1 UPPER DIPPER SWITCH'),
                ('1.1/1.2 USB WIRE ASSY', 1, 'ELEGO 1.1 USB WIRE ASSY'),
                ('1.1/1.2 CONE SET 7 PARTS', 1, 'ELEGO 1.1 CONE SET 7 PARTS'),
                ('1.1/1.2 FRONT FORK ASSY', 1, 'ELEGO 1.1 FRONT FORK ASSY'),
                ('1.1/1.2 REAR SUSPENSION', 2, 'ELEGO 1.1 REAR SUSPENSION'),
                ('1.1/1.2 FRONT SUSPENSION LH', 1, 'ELEGO 1.1 FRONT SUSPENSION LH'),
                ('1.1/1.2 FRONT SUSPENSION RH', 1, 'ELEGO 1.1 FRONT SUSPENSION RH'),
                ('1.1/1.2 ROUND HEAD STAR BUTTON SCREW M3X25 HEAD OD 5mm', 2, 'ROUND HEAD STAR BUTTON SCREW M3X25 HEAD OD 5mm'),
                ('1.1/1.2 ROUND HEAD STAR BUTTON SCREW M4X16 HEAD OD 8mm', 2, 'ROUND HEAD STAR BUTTON SCREW M4X16 HEAD OD 8mm'),
                ('1.1/1.2 ROUND HEAD STAR BUTTON SCREW M6X12 HEAD OD 12mm', 3, 'ROUND HEAD STAR BUTTON SCREW M6X12 HEAD OD 12mm'),
                ('1.1/1.2 HEX FLANGE BOLT M6X12', 33, 'HEX FLANGE BOLT M6X12'),
                ('1.1/1.2 HEX FLANGE BOLT M6X16', 3, 'HEX FLANGE BOLT M6X16'),
                ('1.1/1.2 HEX FLANGE BOLT M6X30', 4, 'HEX FLANGE BOLT M6X30'),
                ('1.1/1.2 HEX FLANGE BOLT M8X16', 1, 'HEX FLANGE BOLT M8X16'),
                ('1.1/1.2 HEX FLANGE BOLT M8X20', 2, 'HEX FLANGE BOLT M8X20'),
                ('1.1/1.2 HEX FLANGE BOLT M10X23 HALF THREAD HS-10.9 Head 10mm Drilled -M6', 1, None),
                ('1.1/1.2 HEX FLANGE BOLT M10X28 HALF THREAD Head 17mm', 2, 'HEX FLANGE BOLT M10X28 HALF THREAD HEAD 17mm'),
                ('1.1/1.2 HEX FLANGE BOLT M10X30', 2, 'HEX FLANGE BOLT M10X30'),
                ('1.1/1.2 HEX FLANGE BOLT M10X 40', 4, None),
                ('1.1/1.2 HEX FLANGE BOLT M10X 45', 1, None),
                ('1.1/1.2 HEX FLANGE BOLT M12X220 HALF THREAD', 1, 'HEX FLANGE BOLT M12X220 HALF THREAD'),
                ('1.1/1.2 HEX FLANGE BOLT M12X225 HALF THREAD', 1, 'HEX FLANGE BOLT M12X225 HALF THREAD'),
                ('1.1/1.2 HANDLE BAR BUSH', 1, 'HANDLE BAR BUSH'),
                ('1.1/1.2 FRONT AXELE BUSH -1 MS', 1, None),
                ('1.1/1.2 FRONT AXELE BUSH-2 MS', 1, None),
                ('1.1/1.2 SELF THREADING ST4 STAR BUTTON SCREW ST4X12mm', 47, None),
                ('1.1/1.2 SELF THREADING ST4 STAR BUTTON SCREW ST5X16mm', 30, None),
                ('1.1/1.2 PLAIN WASHER M6', 2, 'PLAIN WASHER M6'),
                ('1.1/1.2 PLAIN WASHER', 4, 'PLAIN WASHER'),
                ('1.1/1.2 SPRING CLIPS', 25, 'SPRING CLIPS'),
                ('1.1/1.2 HEX FLANGE NUT M3', 2, 'HEX FLANGE NUT M3'),
                ('1.1/1.2 HEX FLANGE NUT M4', 2, 'HEX FLANGE NUT M4'),
                ('1.1/1.2 HEX FLANGE NUT M6', 10, 'HEX FLANGE NUT M6'),
                ('1.1/1.2 HEX FLANGE NUT M8', 2, 'HEX FLANGE NUT M8'),
                ('1.1/1.2 HEX FLANGE NUT M10', 6, 'HEX FLANGE NUT M10'),
                ('1.1/1.2 HEX FLANGE NUT M12', 2, 'HEX FLANGE NUT M12'),
                ('1.1/1.2 MAIN STAND SPRING', 1, 'ELEGO 1.1 MAIN STAND SPRING'),
                ('1.1/1.2 SIDE STAND SPRING', 1, 'ELEGO 1.1 SIDE STAND SPRING'),
                ('TYRE 3-00-10', 1, None),
                ('TYRE 90-90-12', 1, None),
            ],
            'White': [
                ('1.1/1.2 FRONT FENDER WHITE', 1, 'ELEGO 1.1 FRONT FENDER WHITE'),
                ('1.1 FRONT PANEL WHITE', 1, 'ELEGO 1.1 FRONT PANEL WHITE'),
                ('1.1 FRONT PANEL LOGO PART SHINE BLACK', 1, None),
                ('1.1 FRONT PANEL LOGO DECORATION PART', 1, None),
                ('1.1 HEAD HOOD WHITE', 1, 'ELEGO 1.1 HEAD HOOD WHITE'),
                ('1.1 SIDE BODY PANEL LH WHITE', 1, 'ELEGO 1.1 SIDE BODY PANEL LH WHITE'),
                ('1.1 SIDE BODY PANEL RH WHITE', 1, 'ELEGO 1.1 SIDE BODY PANEL RH WHITE'),
                ('1.1/1.2 SIDE EDGE STRIP LH WHITE', 1, 'ELEGO 1.1 SIDE EDGE STRIP LH WHITE'),
                ('1.1/1.2 SIDE EDGE STRIP RH WHITE', 1, 'ELEGO 1.1 SIDE EDGE STRIP RH WHITE'),
                ('1.1/1.2 REAR CONNECTION WHITE', 1, 'ELEGO 1.1 REAR CONNECTION WHITE'),
                ('1.1 BAG HOOK', 1, 'ELEGO 1.1 BAG HOOK'),
                ('1.1 CHASSIS FENDER', 1, 'ELEGO 1.1 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.1 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.1 CONTROLLER CAP SMALL'),
            ...
            'Gray': [
                ('1.1/1.2 FRONT FENDER GRAY', 1, 'ELEGO 1.1 FRONT FENDER GRAY'),
                ('1.1 FRONT PANEL GRAY', 1, 'ELEGO 1.1 FRONT PANEL GRAY'),
                ('1.1 FRONT PANEL LOGO PART SHINE BLACK', 1, None),
                ('1.1 FRONT PANEL LOGO DECORATION PART', 1, None),
                ('1.1 HEAD HOOD GRAY', 1, 'ELEGO 1.1 HEAD HOOD GRAY'),
                ('1.1 SIDE BODY PANEL LH GRAY', 1, 'ELEGO 1.1 SIDE BODY PANEL LH GRAY'),
                ('1.1 SIDE BODY PANEL RH GRAY', 1, 'ELEGO 1.1 SIDE BODY PANEL RH GRAY'),
                ('1.1/1.2 SIDE EDGE STRIP LH GRAY', 1, 'ELEGO 1.1 SIDE EDGE STRIP LH GRAY'),
                ('1.1/1.2 SIDE EDGE STRIP RH GRAY', 1, 'ELEGO 1.1 SIDE EDGE STRIP RH GRAY'),
                ('1.1/1.2 REAR CONNECTION GRAY', 1, 'ELEGO 1.1 REAR CONNECTION GRAY'),
                ('1.1 BAG HOOK', 1, 'ELEGO 1.1 BAG HOOK'),
                ('1.1 CHASSIS FENDER', 1, 'ELEGO 1.1 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.1 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.1 CONTROLLER CAP SMALL'),
            ...
            'Black': [
                ('1.1/1.2 FRONT FENDER BLACK', 1, 'ELEGO 1.1 FRONT FENDER BLACK'),
                ('1.1 FRONT PANEL BLACK', 1, 'ELEGO 1.1 FRONT PANEL BLACK'),
                ('1.1 FRONT PANEL LOGO PART MAT BLACK', 1, 'ELEGO 1.1 FRONT PANEL PART BLACK'),
                ('1.1 FRONT PANEL LOGO DECORATION PART', 1, None),
                ('1.1 HEAD HOOD BLACK', 1, 'ELEGO 1.1 HEAD HOOD BLACK'),
                ('1.1 SIDE BODY PANEL LH BLACK', 1, 'ELEGO 1.1 SIDE BODY PANEL LH BLACK'),
                ('1.1 SIDE BODY PANEL RH BLACK', 1, 'ELEGO 1.1 SIDE BODY PANEL RH BLACK'),
                ('1.1/1.2 SIDE EDGE STRIP LH BLACK', 1, 'ELEGO 1.1 SIDE EDGE STRIP LH BLACK'),
                ('1.1/1.2 SIDE EDGE STRIP RH BLACK', 1, 'ELEGO 1.1 SIDE EDGE STRIP RH BLACK'),
                ('1.1/1.2 REAR CONNECTION BLACK', 1, 'ELEGO 1.1 REAR CONNECTION BLACK'),
                ('1.1 BAG HOOK', 1, 'ELEGO 1.1 BAG HOOK'),
                ('1.1 CHASSIS FENDER', 1, 'ELEGO 1.1 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.1 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.1 CONTROLLER CAP SMALL'),
    ...
    def _ensure_elego_12_color_boms(self):
        ...
        color_components = {
            'Red': [
                ...
                ('1.2 FRONT PANEL LOGO PART SHINE BLACK', 1, None),
                ('1.2 HEAD HOOD RED', 1, 'ELEGO 1.2 HEAD HOOD RED'),
                ('1.2 SIDE BODY PANEL LH RED', 1, 'ELEGO 1.2 SIDE BODY PANEL LH RED'),
                ('1.2 SIDE BODY PANEL RH RED', 1, 'ELEGO 1.2 SIDE BODY PANEL RH RED'),
                ('1.1/1.2 SIDE EDGE STRIP LH RED', 1, 'ELEGO 1.2 SIDE EDGE STRIP LH RED'),
                ('1.1/1.2 SIDE EDGE STRIP RH RED', 1, 'ELEGO 1.2 SIDE EDGE STRIP RH RED'),
                ('1.1/1.2 REAR CONNECTION RED', 1, 'ELEGO 1.2 REAR CONNECTION RED'),
                ('1.2 BAG HOOK', 1, 'ELEGO 1.2 BAG HOOK'),
                ('1.2 CHASSIS FENDER', 1, 'ELEGO 1.2 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.2 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.2 CONTROLLER CAP SMALL'),
                ('1.1/1.2 CONTROLLER FENDER', 1, 'ELEGO 1.2 CONTROLLER FENDER'),
                ('1.1/1.2 FOOT BOARD', 1, 'ELEGO 1.2 FOOT BOARD'),
                ('1.1/1.2 FOOT PLATE COVER', 1, 'ELEGO 1.2 FOOT PLATE COVER'),
                ('1.1/1.2 FOOTMAT', 1, 'ELEGO 1.2 FOOTMAT'),
                ('1.2 FRONT INNER FENDER', 1, 'ELEGO 1.2 FRONT INNER FENDER'),
                ('1.2 FRONT PANEL NET', 1, 'ELEGO 1.2 FRONT PANEL NET'),
                ('1.1/1.2 GRIP DISTANCE PIECE', 1, 'ELEGO 1.2 GRIP DISTANCE PIECE'),
                ('1.2 INSTRUMENT CLUSTER COVER', 1, 'ELEGO 1.2 INSTRUMENT CLUSTER COVER'),
                ('1.1/1.2 DISPLY DECORATION RING RED', 1, None),
                ('1.1/1.2 REAR FENDER', 1, 'ELEGO 1.2 REAR FENDER'),
                ('1.1/1.2 REAR INNER FENDER', 1, 'ELEGO 1.2 REAR INNER FENDER'),
                ('1.1/1.2 ROUND REFLECTOR', 2, 'ELEGO 1.2 ROUND REFLECTOR'),
                ('1.1/1.2 SEAT', 1, 'ELEGO 1.2 SEAT'),
                ('1.1/1.2 SEAT BARREL', 1, 'ELEGO 1.2 SEAT BARREL'),
                ('1.1/1.2 SEAT BARREL FRONT PANEL', 1, 'ELEGO 1.2 SEAT BARREL FRONT PANEL'),
                ('1.1/1.2 SQUARE REFLECTOR', 1, 'ELEGO 1.2 SQUARE REFLECTOR'),
                ('1.1/1.2 SWING ARM COVER LH', 1, 'ELEGO 1.2 SWING ARM COVER LH'),
                ('1.1/1.2 SWING ARM COVER RH', 1, 'ELEGO 1.2 SWING ARM COVER RH'),
                ('1.2 TOOL BOX', 1, 'ELEGO 1.2 TOOL BOX'),
                ('1.2 TOOL BOX CABINATE COVER', 1, 'ELEGO 1.2 TOOL BOX CABINATE COVER'),
                ('1.1/1.2 VIN COVER', 1, 'ELEGO 1.2 VIN COVER'),
                ('1.1/1.2 MIRROR SET', 1, 'ELEGO 1.2 MIRROR SET'),
                ('1.1/1.2 BATTERT CLAMP', 1, 'ELEGO 1.2 BATTERT CLAMP'),
                ('1.2 CHASSIS', 1, 'ELEGO 1.2 CHASSIS FRAME'),
                ('1.1/1.2 FRONT BRAKE CABLE HOLDER CLAMP', 1, 'ELEGO 1.2 FRONT BRAKE CABLE HOLDER CLAMP'),
                ('1.2 FRONT GUARD BRAKET', 1, 'ELEGO 1.2 FRONT GUARD BRAKET'),
                ('1.1/1.2 FRONT RIM', 1, 'ELEGO 1.2 FRONT RIM'),
                ('1.2 HANDAL BAR', 1, 'ELEGO 1.2 HANDAL BAR'),
                ('1.1/1.2 MIDDLE STAND', 1, 'ELEGO 1.2 MIDDLE STAND'),
                ('1.1/1.2 MIDDLE STAND RUBBER', 1, 'ELEGO 1.2 MIDDLE STAND RUBBER'),
                ('1.1/1.2 SEAT LATCH', 1, 'ELEGO 1.2 SEAT LATCH'),
                ('1.1/1.2 SEAT LATCH CABLE', 1, 'ELEGO 1.2 SEAT LATCH CABLE'),
                ('1.1/1.2 SIDE STAND', 1, 'ELEGO 1.2 SIDE STAND'),
                ('1.1/1.2 SWING ARM', 1, 'ELEGO 1.2 SWING ARM'),
                ('1.1/1.2 BRAKE LEVER WITH SENSOR', 1, 'ELEGO 1.2 BRAKE LEVER WITH SENSOR'),
                ('1.1/1.2 FRONT DISC BRAKE PUMP', 1, 'ELEGO 1.2 FRONT DISC BRAKE PUMP'),
                ...
                ('1.1/1.2 NUMBER PLATE', 1, 'ELEGO 1.2 NUMBER PLATE'),
                ('1.1/1.2 REAR BRAKE CABLE', 1, 'ELEGO 1.2 REAR BRAKE CABLE'),
                ('1.1/1.2 REAR BRAKE DRUM PLATE', 1, 'ELEGO 1.2 REAR BRAKE DRUM PLATE'),
                ('1.1/1.2 SIDE GUARD BAR LH', 1, 'ELEGO 1.2 SIDE GUARD BAR LH'),
                ('1.1/1.2 SIDE GUARD BAR RH', 1, 'ELEGO 1.2 SIDE GUARD BAR RH'),
                ('1.1/1.2 ANTI THEFT KIT', 1, 'ELEGO 1.2 ANTI THEFT KIT'),
                ('1.1/1.2 BATTERY CONNECTION BIG WIRE', 1, 'ELEGO 1.2 BATTERY CONNECTION BIG WIRE'),
                ('1.1/1.2 BATTERY CONNECTION SMALL WIRE', 4, 'ELEGO 1.2 BATTERY CONNECTION SMALL WIRE'),
                ('1.1/1.2 CONTROLLER 60/72', 1, None),
                ('1.1/1.2 DC CONVERTER', 1, 'ELEGO 1.2 DC CONVERTER'),
                ('1.2 DISPLY METER', 1, 'ELEGO 1.2 DISPLY METER'),
                ('1.1/1.2 FLASHER', 1, 'ELEGO 1.2 FLASHER'),
                ('1.2 FRONT INDICATOR (LH)', 1, 'ELEGO 1.2 FRONT INDICATOR (LH)'),
                ('1.2 FRONT INDICATOR (RH)', 1, 'ELEGO 1.2 FRONT INDICATOR (RH)'),
                ('1.1/1.2 HEAD LIGHT ON/OFF SWITCH', 1, None),
                ('1.2 HEADLAMP ASSY', 1, 'ELEGO 1.2 HEADLAMP ASSY'),
                ('1.2 HEADLAMP BULB', 1, 'ELEGO 1.2 HEADLAMP BULB'),
                ('1.1/1.2 HORN & PARKING SWITCH COMBO', 1, None),
                ('1.1/1.2 IGNITION LOCK', 1, 'ELEGO 1.2 IGNITION LOCK'),
                ('1.1/1.2 INDICATOR SWITCH', 1, 'ELEGO 1.2 INDICATOR SWITCH'),
                ('1.1/1.2 GEAR SWITCH', 1, None),
                ('1.2 MAIN WIRE HARNESS', 1, 'ELEGO 1.2 MAIN WIRE HARNESS'),
                ('1.1/1.2 MCB', 1, 'ELEGO 1.2 MCB'),
                ('1.1/1.2 MOTOR', 1, 'ELEGO 1.2 MOTOR'),
                ('1.1/1.2 NUMBER PLATE LIGHT', 1, 'ELEGO 1.2 NUMBER PLATE LIGHT'),
                ('1.1/1.2 TAIL LIGHT ASSY', 1, 'ELEGO 1.2 TAIL LIGHT ASSY'),
                ('1.1/1.2 THROTTLE + GRIP', 1, 'ELEGO 1.2 THROTTLE + GRIP'),
                ('1.1/1.2 UPPER DIPPER SWITCH', 1, 'ELEGO 1.2 UPPER DIPPER SWITCH'),
                ('1.1/1.2 USB WIRE ASSY', 1, 'ELEGO 1.2 USB WIRE ASSY'),
                ('1.1/1.2 CONE SET 7 PARTS', 1, 'ELEGO 1.2 CONE SET 7 PARTS'),
                ('1.1/1.2 FRONT FORK ASSY', 1, 'ELEGO 1.2 FRONT FORK ASSY'),
                ('1.1/1.2 REAR SUSPENSION', 2, 'ELEGO 1.2 REAR SUSPENSION'),
                ('1.1/1.2 FRONT SUSPENSION LH', 1, 'ELEGO 1.2 FRONT SUSPENSION LH'),
                ('1.1/1.2 FRONT SUSPENSION RH', 1, 'ELEGO 1.2 FRONT SUSPENSION RH'),
                ('ROUND HEAD STAR BUTTON SCREW M3X25 HEAD OD 5mm', 2, 'ROUND HEAD STAR BUTTON SCREW M3X25 HEAD OD 5mm'),
                ('ROUND HEAD STAR BUTTON SCREW M4X16 HEAD OD 8mm', 2, 'ROUND HEAD STAR BUTTON SCREW M4X16 HEAD OD 8mm'),
                ('ROUND HEAD STAR BUTTON SCREW M6X12 HEAD OD 12mm', 3, 'ROUND HEAD STAR BUTTON SCREW M6X12 HEAD OD 12mm'),
                ('HEX FLANGE BOLT M6X12', 33, 'HEX FLANGE BOLT M6X12'),
                ('HEX FLANGE BOLT M6X16', 3, 'HEX FLANGE BOLT M6X16'),
                ('HEX FLANGE BOLT M6X30', 4, 'HEX FLANGE BOLT M6X30'),
                ('HEX FLANGE BOLT M8X16', 1, 'HEX FLANGE BOLT M8X16'),
                ('HEX FLANGE BOLT M8X20', 2, 'HEX FLANGE BOLT M8X20'),
                ('HEX FLANGE BOLT M10X23 HALF THREAD HS-10.9 Head 10mm Drilled -M6', 1, 'HEX FLANGE BOLT M10X23 HALF THREAD HS-10.9 Head 10mm Drilled -M6'),
                ('HEX FLANGE BOLT M10X28 HALF THREAD Head 17mm', 2, 'HEX FLANGE BOLT M10X28 HALF THREAD Head 17mm'),
                ('HEX FLANGE BOLT M10X30', 2, 'HEX FLANGE BOLT M10X30'),
                ('HEX FLANGE BOLT M10X 40', 4, 'HEX FLANGE BOLT M10X 40'),
                ('HEX FLANGE BOLT M10X 45', 1, 'HEX FLANGE BOLT M10X 45'),
                ('HEX FLANGE BOLT M12X220 HALF THREAD', 1, 'HEX FLANGE BOLT M12X220 HALF THREAD'),
                ('HEX FLANGE BOLT M12X225 HALF THREAD', 1, 'HEX FLANGE BOLT M12X225 HALF THREAD'),
                ('HANDLE BAR BUSH', 1, 'HANDLE BAR BUSH'),
                ('FRONT AXELE BUSH -1 MS', 1, 'FRONT AXELE BUSH -1 MS'),
                ('FRONT AXELE BUSH-2 MS', 1, 'FRONT AXELE BUSH-2 MS'),
                ('SELF THREADING ST4 STAR BUTTON SCREW ST4X12mm', 47, 'SELF THREADING ST4 STAR BUTTON SCREW ST4X12mm'),
                ('SELF THREADING ST4 STAR BUTTON SCREW ST5X16mm', 30, 'SELF THREADING ST4 STAR BUTTON SCREW ST5X16mm'),
                ('PLAIN WASHER M6', 2, 'PLAIN WASHER M6'),
                ('SPRING CLIPS', 25, 'SPRING CLIPS'),
                ('HEX FLANGE NUT M3', 2, 'HEX FLANGE NUT M3'),
                ('HEX FLANGE NUT M4', 2, 'HEX FLANGE NUT M4'),
                ('HEX FLANGE NUT M6', 10, 'HEX FLANGE NUT M6'),
                ('HEX FLANGE NUT M8', 2, 'HEX FLANGE NUT M8'),
                ('HEX FLANGE NUT M10', 6, 'HEX FLANGE NUT M10'),
                ('HEX FLANGE NUT M12', 2, 'HEX FLANGE NUT M12'),
                ('MAIN STAND SPRING', 1, 'ELEGO 1.2 MAIN STAND SPRING'),
                ('SIDE STAND SPRING', 1, 'ELEGO 1.2 SIDE STAND SPRING'),
                ('TYRE 3-00-10', 1, None),
                ('TYRE 90-90-12', 1, None),
            ],
            'White': [
                ('1.1/1.2 FRONT FENDER WHITE', 1, 'ELEGO 1.2 FRONT FENDER WHITE'),
                ('1.2 FRONT PANEL WHITE', 1, 'ELEGO 1.2 FRONT PANEL WHITE'),
                ('1.2 FRONT PANEL LOGO PART SHINE BLACK', 1, None),
                ('1.2 HEAD HOOD WHITE', 1, 'ELEGO 1.2 HEAD HOOD WHITE'),
                ('1.2 SIDE BODY PANEL LH WHITE', 1, 'ELEGO 1.2 SIDE BODY PANEL LH WHITE'),
                ('1.2 SIDE BODY PANEL RH WHITE', 1, 'ELEGO 1.2 SIDE BODY PANEL RH WHITE'),
                ('1.1/1.2 SIDE EDGE STRIP LH WHITE', 1, 'ELEGO 1.2 SIDE EDGE STRIP LH WHITE'),
                ('1.1/1.2 SIDE EDGE STRIP RH WHITE', 1, 'ELEGO 1.2 SIDE EDGE STRIP RH WHITE'),
                ('1.1/1.2 REAR CONNECTION WHITE', 1, 'ELEGO 1.2 REAR CONNECTION WHITE'),
                ('1.2 BAG HOOK', 1, 'ELEGO 1.2 BAG HOOK'),
                ('1.2 CHASSIS FENDER', 1, 'ELEGO 1.2 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.2 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.2 CONTROLLER CAP SMALL'),
                ...
                ('1.1/1.2 GRIP DISTANCE PIECE', 1, 'ELEGO 1.2 GRIP DISTANCE PIECE'),
                ('1.2 INSTRUMENT CLUSTER COVER', 1, 'ELEGO 1.2 INSTRUMENT CLUSTER COVER'),
                ('1.1/1.2 DISPLY DECORATION RING WHITE', 1, None),
                ('1.1/1.2 REAR FENDER', 1, 'ELEGO 1.2 REAR FENDER'),
                ('1.1/1.2 REAR INNER FENDER', 1, 'ELEGO 1.2 REAR INNER FENDER'),
                ('1.1/1.2 ROUND REFLECTOR', 2, 'ELEGO 1.2 ROUND REFLECTOR'),
                ('1.1/1.2 SEAT', 1, 'ELEGO 1.2 SEAT'),
            ...
            'Gray': [
                ('1.1/1.2 FRONT FENDER GRAY', 1, 'ELEGO 1.2 FRONT FENDER GRAY'),
                ('1.2 FRONT PANEL GRAY', 1, 'ELEGO 1.2 FRONT PANEL GRAY'),
                ('1.2 FRONT PANEL LOGO PART SHINE BLACK', 1, None),
                ('1.2 HEAD HOOD GRAY', 1, 'ELEGO 1.2 HEAD HOOD GRAY'),
                ('1.2 SIDE BODY PANEL LH GRAY', 1, 'ELEGO 1.2 SIDE BODY PANEL LH GRAY'),
                ('1.2 SIDE BODY PANEL RH GRAY', 1, 'ELEGO 1.2 SIDE BODY PANEL RH GRAY'),
                ('1.1/1.2 SIDE EDGE STRIP LH GRAY', 1, 'ELEGO 1.2 SIDE EDGE STRIP LH GRAY'),
                ('1.1/1.2 SIDE EDGE STRIP RH GRAY', 1, 'ELEGO 1.2 SIDE EDGE STRIP RH GRAY'),
                ('1.1/1.2 REAR CONNECTION GRAY', 1, 'ELEGO 1.2 REAR CONNECTION GRAY'),
                ('1.2 BAG HOOK', 1, 'ELEGO 1.2 BAG HOOK'),
                ('1.2 CHASSIS FENDER', 1, 'ELEGO 1.2 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.2 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.2 CONTROLLER CAP SMALL'),
                ...
                ('1.1/1.2 GRIP DISTANCE PIECE', 1, 'ELEGO 1.2 GRIP DISTANCE PIECE'),
                ('1.2 INSTRUMENT CLUSTER COVER', 1, 'ELEGO 1.2 INSTRUMENT CLUSTER COVER'),
                ('1.1/1.2 DISPLY DECORATION RING GRAY', 1, None),
                ('1.1/1.2 REAR FENDER', 1, 'ELEGO 1.2 REAR FENDER'),
                ('1.1/1.2 REAR INNER FENDER', 1, 'ELEGO 1.2 REAR INNER FENDER'),
                ('1.1/1.2 ROUND REFLECTOR', 2, 'ELEGO 1.2 ROUND REFLECTOR'),
                ('1.1/1.2 SEAT', 1, 'ELEGO 1.2 SEAT'),
            ...
            'Black': [
                ('1.1/1.2 FRONT FENDER BLACK', 1, 'ELEGO 1.2 FRONT FENDER BLACK'),
                ('1.2 FRONT PANEL BLACK', 1, 'ELEGO 1.2 FRONT PANEL BLACK'),
                ('1.2 FRONT PANEL LOGO PART MAT BLACK', 1, 'ELEGO 1.2 FRONT PANEL PART BLACK'),
                ('1.2 HEAD HOOD BLACK', 1, 'ELEGO 1.2 HEAD HOOD BLACK'),
                ('1.2 SIDE BODY PANEL LH BLACK', 1, 'ELEGO 1.2 SIDE BODY PANEL LH BLACK'),
                ('1.2 SIDE BODY PANEL RH BLACK', 1, 'ELEGO 1.2 SIDE BODY PANEL RH BLACK'),
                ('1.1/1.2 SIDE EDGE STRIP LH BLACK', 1, 'ELEGO 1.2 SIDE EDGE STRIP LH BLACK'),
                ('1.1/1.2 SIDE EDGE STRIP RH BLACK', 1, 'ELEGO 1.2 SIDE EDGE STRIP RH BLACK'),
                ('1.1/1.2 REAR CONNECTION BLACK', 1, 'ELEGO 1.2 REAR CONNECTION BLACK'),
                ('1.2 BAG HOOK', 1, 'ELEGO 1.2 BAG HOOK'),
                ('1.2 CHASSIS FENDER', 1, 'ELEGO 1.2 CHASSIS FENDER'),
                ('1.1/1.2 CONTROLLER CAP BIG', 1, 'ELEGO 1.2 CONTROLLER CAP BIG'),
                ('1.1/1.2 CONTROLLER CAP SMALL', 1, 'ELEGO 1.2 CONTROLLER CAP SMALL'),
                ...
                ('1.1/1.2 GRIP DISTANCE PIECE', 1, 'ELEGO 1.2 GRIP DISTANCE PIECE'),
                ('1.2 INSTRUMENT CLUSTER COVER', 1, 'ELEGO 1.2 INSTRUMENT CLUSTER COVER'),
                ('1.1/1.2 DISPLY DECORATION RING BLACK', 1, None),
                ('1.1/1.2 REAR FENDER', 1, 'ELEGO 1.2 REAR FENDER'),
                ('1.1/1.2 REAR INNER FENDER', 1, 'ELEGO 1.2 REAR INNER FENDER'),
                ('1.1/1.2 ROUND REFLECTOR', 2, 'ELEGO 1.2 ROUND REFLECTOR'),
                ('1.1/1.2 SEAT', 1, 'ELEGO 1.2 SEAT'),
